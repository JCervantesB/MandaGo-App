...
// Banner de alerta para mostrar incidencias activas del cliente
export function IncidentAlertBanner({ onPress }: IncidentAlertBannerProps) {
  ...
  return (
    <Pressable
      onPress={onPress}
      className="bg-red-50 border border-red-200 rounded-xl p-3 mx-4 mb-3 flex-row items-center"
    >
